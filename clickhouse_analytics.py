...
High-performance log analysis and queries
"""
...
class ClickHouseAnalytics:
    """High-performance analytics for system logs using ClickHouse."""
...
def main():
    """Main function to demonstrate ClickHouse analytics."""
    print("🚀 ClickHouse Analytics for System Logs")
    print("=" * 50)
    ...
    try:
        ...
        print("💡 Make sure ClickHouse is running: ./start_clickhouse.sh")
        return
    ...
    print("\n" + "=" * 50)
    print("🎉 ClickHouse Analytics Complete!")
    print("💡 Try these queries:")
    print("   - Search for specific errors: search_logs(level='error', search_term='failed')")
    print("   - Get trends: get_error_trends(hours=24)")
    print("   - Export data: export_to_csv(query, 'logs.csv')")
